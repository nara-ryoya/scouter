                    ...
                    for fx, fy, fw, fh in faces:
                        ...
                        if rec_mode:
                            ...
                            if len(face_landmarks) != 0:
                                ...
                                cv2.ellipse(tmp, (center_x, center_y), (radius//3, radius//3), angle=30, startAngle=arg, endAngle=arg+240, color=textColor, thickness=2)
                                cv2.ellipse(tmp, (center_x, center_y), (radius+10, radius+10), angle=45, startAngle=arg//2, endAngle=300+arg//2, color=textColor, thickness=4)
                                cv2.ellipse(tmp, (center_x, center_y), (radius+20, radius+20), angle=120, startAngle=arg//2, endAngle=300+arg//2, color=textColor, thickness=1)
